			...
			frappe.call({
				...
				callback: function(r){
					if(!r.exc) {
						...
						if (frm.doc.currency != doc[0].paid_from_account_currency){
							doc[0].base_paid_amount = frm.doc.grand_total
							doc[0].base_received_amount = frm.doc.grand_total
							doc[0].base_total_allocated_amount = frm.doc.grand_total
							doc[0].paid_amount = frm.doc.grand_total
							doc[0].received_amount = frm.doc.grand_total
							doc[0].total_allocated_amount = frm.doc.grand_total
						}
